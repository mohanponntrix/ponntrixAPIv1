...
public class DocumentsServiceImpl implements DocumentsService {
    ...
    @Override
    public List<DocumentsDto> getDocument(EntityType entityType, UUID entityId) {
    ...
    @Override
    public List<DocumentsDto> getDocumentsByType(EntityType entityType) {
    ...
    @Override
    public DocumentsDto updateDocument(
            UUID documentsId,
            DocumentsDto dto,
            MultipartFile file) throws IOException {

        Documents document = documentsRepository.findByDocumentsUUID(documentsId)
                .orElseThrow(() ->
    ...
    @Override
    public DocumentsDto verifyDocument(UUID documentsId) {

        Documents document =
                documentsRepository.findByDocumentsUUID(documentsId)
                        .orElseThrow(() ->
                                new RuntimeException("Document not found."));
    ...
    @Override
    public void deleteDocument(UUID documentsId) {
        Documents document = documentsRepository.findByDocumentsUUID(documentsId)
    ...
    @Override
    public ResponseEntity<Resource> downloadDocument(UUID documentsId) throws IOException {
    ...
    @Override
    public ResponseEntity<InputStreamResource> previewDocument(UUID documentsId) {
